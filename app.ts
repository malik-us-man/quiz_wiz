...
const quiz: {
  ...
  },
  {
    ...
    type: "list",
    message:
    chalk.bold.bgMagenta("Q5. Who was the captain of the Pakistan cricket team when they won the ICC Cricket World Cup in 1992?"),
    choices: [
      "A) Wasim Akram",
      "B) Javed Miandad",
      "C) Imran Khan",
  ...
  },
  {
    ...
    type: "list",
    message:
    chalk.bold.bgMagenta("Q6. In which year did Pakistan win their first ICC T20 World Cup?"),
